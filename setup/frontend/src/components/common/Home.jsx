...
import './Home.css';
import landingImage from '../../Images/landing.png'; // ✅ your image
  ...
  return (
    <div className="landing-page">
        ...
        <Container>
          <Row className="align-items-center">
            ...
            <Col md={6} data-aos="fade-left" className="text-md-start text-center mt-md-0 mt-4">
              <h1 className="display-5 fw-bold">Empower Your Team</h1>
              <p className="lead text-secondary">
                Exceed Customer Expectations: Discover our <br /> Complaint Management Solution
              </p>
              <Button href="/signup" variant="primary" size="lg" className="mt-3">
      ...
      <footer className="bg-dark text-white text-center py-4">
        <Container>
          <p className="mb-0">&copy; {new Date().getFullYear()} ComplaintCare. All Rights Reserved.</p>
        </Container>
      </footer>
    </div>
  );
