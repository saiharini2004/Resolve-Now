...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem('userName', res.data.name); // ✅ Store user name

      // ✅ Redirect based on userType
      const userType = res.data.userType;
      if (userType === 'admin') navigate('/admin/accordion'); // ✅ modified line
      else if (userType === 'agent') navigate('/agent/home');
